                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    while ($asp = mysqli_fetch_assoc($sql_tmp)) {
                                        $t_kos = $asp['kd_tmp'];
                                        $pb = mysqli_fetch_assoc(mysqli_query($conn, "SELECT t_kos, COUNT(*) as total FROM kunci WHERE tahun = '$tahun' AND bulan = $bulan AND ket = 0 AND t_kos = $t_kos "));
                                    ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><?= $asp['nama'] ?></td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $sql_tmp2 = mysqli_query($conn, "SELECT * FROM tempat");

                                    while ($kks = mysqli_fetch_assoc($sql_tmp2)) {
                                        $t_kok = $kks['kd_tmp'];
                                        $d_sk = mysqli_fetch_assoc(mysqli_query($conn, "SELECT t_kos, COUNT(*) as total FROM kunci WHERE tahun = '$tahun' AND bulan = $bulan AND ket = 0 AND t_kos = $t_kok "));

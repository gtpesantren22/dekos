...
<section class="content">
    <div class="row">
        ...
        if (isset($_POST['cari'])) {
            ...
            $masuk = mysqli_query($conn, "SELECT tgl, bulan, SUM(nominal) AS total FROM kos WHERE bulan = $bulan AND tahun = '$tahun' GROUP BY tgl");
            ...
            $str = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(pa) AS pa, SUM(pi) AS pi, bulan FROM setor WHERE bulan = $bulan AND tahun = '$tahun' GROUP BY bulan "));

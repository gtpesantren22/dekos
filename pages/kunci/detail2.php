...
$dt = mysqli_query($conn, "SELECT * FROM kunci WHERE bulan = $bln AND t_kos = $tks AND tahun = '$thn' GROUP BY ket ");
                        ...
                        <div class="table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    $st = mysqli_query($conn, "SELECT * FROM kunci WHERE ket = $k AND bulan = $bln AND tahun = '$thn' AND t_kos = $tks ");

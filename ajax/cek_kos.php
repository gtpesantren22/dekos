...
<div class="col-md-12">
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            mysqli_query($conn, "CREATE VIEW rekap AS SELECT SUM(a.nominal) AS jml, b.nama, b.k_formal, b.nis, b.t_formal, b.r_formal, b.jurusan FROM kos a 
                            JOIN kunci b ON a.nis = b.nis WHERE b.k_formal = '$kls' AND b.t_formal = '$tingkat' AND b.r_formal = '$rom' AND b.jurusan = '$jur' 
                            AND a.bulan = $bulan AND a.tahun = '$tahun' AND b.bulan = $bulan AND b.tahun = '$tahun' AND ket = 0 GROUP BY nis ORDER BY nominal ASC");

            mysqli_query($conn, "CREATE VIEW rekap2 AS SELECT nama, nis FROM kunci WHERE k_formal = '$kls' AND t_formal = '$tingkat' AND r_formal = '$rom' AND jurusan = '$jur' AND ket = 0  AND bulan = $bulan AND tahun = '$tahun' ");
